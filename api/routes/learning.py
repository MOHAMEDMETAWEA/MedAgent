...
async def get_model_analytics(current_user: Any = Depends(get_current_admin_user)):
    ...
    try:
        ...
        current_metrics = registry_data["models"].get(current_model_id, {}).get("metrics", {})
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve model analytics: {str(e)}")
