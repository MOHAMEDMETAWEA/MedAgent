...
class TestEmergencyGuardrails(unittest.TestCase):
    def test_stroke_detection(self):
        result = MedicalSafetyFramework.classify_risk(
            "I have sudden numbness on one side of my body and slurred speech."
        )
        self.assertEqual(result, "Emergency")

    def test_severe_bleeding(self):
        result = MedicalSafetyFramework.classify_risk(
            "I am bleeding heavily from a deep cut and feel dizzy."
        )
    ...
    def test_psychiatric_crisis(self):
        ...
        result = MedicalSafetyFramework.classify_risk(
            "I am feeling very hopeless and want to hurt myself."
        )
        self.assertEqual(result, "Emergency")
