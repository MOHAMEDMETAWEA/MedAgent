...
def test_dataset_builder_format():
    ...
    mock_samples = [
        {"input": "Patient has fever", "output": "Prescribe paracetamol", "id": 1, "type": "correction", "rating": 5}
    ]
...
async def test_registry_promotion():
    ...
    model_registry.register_model(version="2.0.0-test", checkpoint_path="/tmp/test", metrics={"accuracy_proxy": 0.95})
