...
DIAGNOSIS_SCHEMA = {
    ...
    "properties": {
        "diagnosis": {
            "type": "string",
            "description": "The primary clinical impression or differential diagnosis.",
        },
        "reasoning": {
            "type": "string",
            "description": "The step-by-step logic used to arrive at the diagnosis.",
        },
        ...
        "uncertainty_disclosure": {
            "type": "string",
            "description": "Mandatory disclosure of what remains uncertain.",
        },
    },
    "required": [
        "diagnosis",
...
TRIAGE_SCHEMA = {
    ...
    "properties": {
        "priority_level": {
            ...
            "minimum": 1,
            "maximum": 5,
            "description": "ESI (Emergency Severity Index) level.",
        },
...
IMAGE_ANALYSIS_SCHEMA = {
    ...
    "properties": {
        "findings": {
            "type": "string",
            "description": "Detailed description of anomalies or features found in the image.",
        },
...
SAFETY_AUDIT_SCHEMA = {
    ...
    "properties": {
        ...
        "redacted_content": {
            "type": "string",
            "description": "The response with PII or unsafe medical advice removed.",
        },
